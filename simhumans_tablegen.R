#
# simhumans_tablegen.R - given data from human subjects experiment runs,
#                        compute summary statistics and output to a file
#                        to allow simulation of these human agents
# 
